...
- [SFI-JH Lab Website](https://www.epfl.ch/labs/sfi-jh/)
...
- **New book published (May 2025):** *The Economics of Over-the-Counter Markets* (with Benjamin Lester and Pierre-Olivier Weill) released by **Princeton University Press** — a comprehensive toolkit for the analysis of decentralised exchanges.
- **New journal publication (Nov 2025):** "Perpetual Futures Pricing" (with Damien Ackerer and Urban Jermann) accepted and forthcoming in **Mathematical Finance**; won the **EFA 2024 Best Conference Paper Prize**.
- **Working paper under revision (Oct 2025):** "Admissible Surplus Dynamics and the Government Debt Puzzle" (with Pierre Collin-Dufresne and Elena Perazzi), revised October 2025.
- **Working paper R&R (Oct 2025):** "Heterogeneous Beliefs Recovery" (with Darius Nik Nejad) under R&R at **Review of Financial Studies**.
- **New working paper in preparation (Jun 2025):** "Onto those that have shall more be given: A model of asset-based lending" (with Stéphane Villeneuve).
- **Published in Management Science (Aug 2024):** "Asset Pricing with Costly Short Sales" (with Rodolfo Prieto).
