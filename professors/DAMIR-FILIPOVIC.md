...
- **Initial profile created** for Damir Filipovic (Swissquote Chair in Quantitative Finance, EPFL).
- Recent publications (2025) include:
  - *Stripping the Discount Curve — A Robust Machine Learning Approach* published in **Management Science** (Dec 2025).
  - *Fixed-Income Pricing and the Replication of Liabilities* posted on arXiv (Dec 2025).
  - *Error Propagation in Dynamic Programming: From Stochastic Control to Option Pricing* posted on arXiv (Sep 2025).
  - *Sparse Portfolio Selection via Topological Data Analysis based Clustering* published in **Quantitative Finance** (Aug 2025).
  - *Transfer Learning Across Fixed-Income Product Classes* posted on arXiv (May 2025).
  - *Ensemble Learning for Portfolio Valuation and Risk Management* published in **Quantitative Finance** (Mar 2025).
  - *Adaptive Joint Distribution Learning* published in **SIAM Journal on Mathematics of Data Science** (Jan 2025).
  - *Kernel Density Machines* posted on SSRN (2025).
- Active PhD students: Joshua Hayes, Andrea Ruglioni.
- Recent PhD completions: Le Moal Quentin (2025), Nicolas Etienne Camenzind (2026).
- Prof. Filipovic is also a member of the **ETH FinsureTech Hub**.
