...
- [SFI-PCD Lab Website](https://www.epfl.ch/labs/sfi-pcd/)
- [EPFL People Profile](https://people.epfl.ch/pierre.collin-dufresne)
...
- **Initial profile created.** Pierre Collin-Dufresne holds the SFI Chair at EPFL (CDM faculty), working on asset pricing, credit markets, market microstructure, and information in financial markets.
- **EFA 2024 Best Conference Paper Prize** awarded by the European Finance Association — the most recent award listed on his EPFL profile.
- **Active working paper (2023):** "Admissible Surplus Dynamics and the Government Debt Puzzle" (with Julien Hugonnier and Elena Perazzi, EPFL), presented in 2023.
- **Recent archival uploads (late 2024/early 2025):** Several older discussion papers from 2006–2016 were newly posted on the lab website (e.g., CDS discussions, credit risk roundtables), suggesting ongoing curation of the research record.
- No new GitHub repositories or ORCID/OpenAlex publication data available; no code infrastructure configured for this lab.
- Current PhD students: Luca Pagliuca, Federico Baldi Lanfranchi, Darius Nik Nejad.
