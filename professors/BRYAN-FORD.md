...
- No materially new developments since the last update. The freshly fetched data confirms the same recent publications (Limix at NINeS 2026, TRIP/Votegral at ACM CCS 2025, ZeroAuction at FC 2025) and active repositories (`kyber`, `quepaxa`, `gd-pure`, `votegral`, `limix`) already captured in the prior changelog. The most recently pushed repo is `terraform-provider-libvirt` (2026-07-03), a lab infrastructure utility with no research significance.
