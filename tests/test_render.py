...
def _prof():
    return Professor(
        ...
        name="Bryan Ford",
        lab="DEDIS",
        epfl_profile="https://people.epfl.ch/bryan.ford",
        lab_urls=["https://dedis.epfl.ch/", "https://bford.info/"],
...
def test_readme_shows_verification_links_even_when_unreviewed(tmp_path):
    profs = [
        Professor(
            ...
            name="Amy A",
            lab="LabA",
            epfl_profile="https://people.epfl.ch/amy.a",
            lab_urls=["https://laba.example/", "https://amy.example/"],
